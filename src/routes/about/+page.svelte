<main class="z-10">
  <section id="about">
    <div class="mx-auto max-w-2xl lg:max-w-3xl p-15 text-justify">
      ...
      <p>
        I spent the first 22 years of my life in Minnesota: the first 18 growing
        up in Saint Paul attending public schools, and the subsequent four at
        Carleton College where I captained the track team and studied math,
